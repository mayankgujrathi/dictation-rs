...
pub fn calculate_bar_x(index: usize, num_bars: usize, rect_width: f32, rect_left: f32) -> f32 {
...
mod frame_calculation_tests {
  ...
  fn test_samples_for_duration() {
    ...
    let sample_rate = 16000u32;
    let expected_samples = (duration_ms as f64 / 1000.0 * sample_rate as f64) as usize;
